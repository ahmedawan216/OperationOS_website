    ...
    <main className="min-h-screen bg-bg px-5 pb-20 pt-28 sm:px-8">
      <div className="mx-auto max-w-wrap">
        ...
        <Link
          href={
            jobId
              ? `/dashboard/agents/recruitos/jobs/${jobId}`
        ...
        <div className="mb-12 max-w-[700px]">
          ...
          <p className="mt-5 text-[15px] leading-[1.7] text-ink-dim">
            ...
            and RecruitOS will analyze their
            fit against the selected job.
          </p>
        </div>

        {!jobId && (
          <div className="mb-5 max-w-[720px] rounded-xl border border-yellow-400/30 p-6">
            <p className="text-sm text-yellow-300">
              No job has been selected.
              Please choose a job before
              analyzing a candidate.
            </p>

            <Link
              href="/dashboard/agents/recruitos/jobs"
              className="mt-4 inline-flex rounded-lg border border-border px-5 py-3 text-sm font-medium text-ink transition-colors hover:border-accent hover:text-accent"
            >
              Choose a job
            </Link>
          </div>
          ...
          <div className="rounded-xl border border-border p-6 sm:p-8">
            ...
            <form action={formAction}>
              <input
                ...
                required
                disabled={!jobId}
                className="block w-full cursor-pointer rounded-lg border border-border bg-transparent px-4 py-3 text-sm text-ink file:mr-4 file:rounded-md file:border-0 file:bg-ink file:px-4 file:py-2 file:text-sm file:font-medium file:text-bg disabled:cursor-not-allowed disabled:opacity-50"
              />
            ...
            jobId && (
              <div className="mt-5 rounded-xl border border-border p-6 sm:p-8">
                ...
                <div className="mb-8">
                  ...
                  <p className="mt-2 text-sm leading-[1.6] text-ink-dim">
                    RecruitOS will compare the
                    resume against the selected
                    job description.
                  </p>
                </div>
