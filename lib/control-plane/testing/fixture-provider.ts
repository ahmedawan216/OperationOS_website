...
export const fixtureSnapshot: ControlPlaneSnapshot = {
  ...
  evaluations: [{ evaluationId: "eval-routing-v1", candidateId: "candidate-routing-v1", baselineVersionId: "manager-v1", datasetVersionId: "routing-dataset-v1", evaluatorVersionIds: ["workflow.quality.v1", "safety.v1", "latency.v1"], status: "improved", metricSummary: [{ key: "workflow.success", baseline: .72, candidate: .86, result: "improved" }, { key: "latency.ms", baseline: 940, candidate: 910, result: "improved" }, { key: "safety.pass", baseline: 1, candidate: 1, result: "unchanged" }], regressionIds: [], riskGateDecision: "require_human_approval" }],
  safety: [{ assessmentId: "safety-routing-v1", candidateId: "candidate-routing-v1", severity: "medium", guardianDisposition: "require_human_review", runtimeDisposition: "awaiting exact action-bound approval", findingSummaries: ["Routing behavior changes require bounded canary review."], evidenceIds: ["eval-routing-v1", "trace-104"], assessedAt: "2026-09-22T17:24:00.000Z" }],
  approvals: [{ approvalId: "approval-canary-v1", actionType: "candidate.canary.start", subjectId: "candidate-routing-v1", actionDigest: digestB, payloadSummary: "Start a 5% non-production preview canary for candidate-routing-v1 against manager-v1.", risk: "medium", status: "pending", expiresAt: "2026-09-23T18:00:00.000Z", evaluationId: "eval-routing-v1", assessmentId: "safety-routing-v1" }],
  versions: [{ versionId: "manager-v1", status: "known_good", digest: digestA, pointer: "known_good", createdAt: "2026-09-21T12:00:00.000Z" }, { versionId: "candidate-routing-v1", status: "candidate", digest: digestB, pointer: "none", createdAt: "2026-09-22T17:12:00.000Z" }],
  canaries: [{ canaryId: "canary-history-01", state: "rolled_back", candidateVersionId: "candidate-timeout-v1", knownGoodVersionId: "manager-v1", rollbackVersionId: "manager-v1", target: "preview", allocationPercent: 5, productionActivationAllowed: false, eventSummaries: ["Canary started in preview.", "Latency threshold breached.", "Rolled back to manager-v1."] }],
